...
;; Disable C-l
(define-key evil-normal-state-map (kbd "C-l") '(lambda () (interactive) (message "Key disabled")))
(define-key evil-insert-state-map (kbd "C-l") '(lambda () (interactive) (message "Key disabled")))
(define-key evil-normal-state-map (kbd "C-l") '(lambda () (interactive) (message "Key disabled")))
#+END_SRC
