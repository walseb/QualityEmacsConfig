...
#+BEGIN_SRC emacs-lisp
  (defun my/auto-eval ()
    ...
    (if (eq evil-state 'visual)
      ...
      (if (not (cond
                ...
                ((string= major-mode "plantuml-mode") (plantuml-preview-region 0 (line-beginning-position) (line-end-position)))
  ...
  (defun my/auto-eval-region ()
    (interactive)
    (if (not (cond
              ((string= major-mode "clojure-mode") (cider-eval-region (point) (mark t))) 
              ((string= major-mode "plantuml-mode") (plantuml-preview-region 0 (point) (mark t)))
              ((string= major-mode "fsharp-mode") (fsharp-eval-region (point) (mark t)))))
  ...
  (defun my/auto-eval-buffer ()
    ...
    (if (not (cond
              ...
              ((string= major-mode "plantuml-mode") (plantuml-preview-buffer 0))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; By default exwm buffers start in emacs state
