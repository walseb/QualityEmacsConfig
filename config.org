...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/leader-map (kbd "M-l") 'my/switch-monitor-right)
  (define-key my/leader-map (kbd "M-h") 'my/switch-monitor-left)
#+END_SRC
    ...
    (if (not (eq my/mode-line-alert-status 'normal))
        (progn
          ...
          (if window-system
            ...
            (set-face-foreground 'mode-line-inactive my/mode-line-background)
            (set-face-background 'mode-line-inactive my/mode-line-foreground)))))
    ...
    (if (not (eq my/mode-line-alert-status 'warning))
        (progn
          ...
          (if window-system
            ...
            (set-face-foreground 'mode-line-inactive my/mode-line-warning-background)
            (set-face-background 'mode-line-inactive my/mode-line-warning-foreground)))))
  ...
  (if (not (eq my/mode-line-alert-status 'caution))
      (progn
        ...
        (if window-system
          ...
          (set-face-foreground 'mode-line-inactive my/mode-line-caution-background)
          (set-face-background 'mode-line-inactive my/mode-line-caution-foreground)))))
                    ...
                    (quote
                     (
                      ...
                      (:eval (if my/mode-line-enable-network-traffic
                                 (concat
                                  my/rx-delta-formatted " R "
                                  my/tx-delta-formatted " T")))
