...
#+BEGIN_SRC emacs-lisp
  (define-key help-mode-map (kbd "C-u") 'my/evil-scroll-up)
  (define-key help-mode-map (kbd "t") 'my/leader-map)
#+END_SRC
...
Doesn't work??
#+BEGIN_SRC emacs-lisp
;;  (evil-define-key 'normal ivy-occur-mode-map (kbd "C-u") 'evil-scroll-up)
;;  (evil-define-key 'normal ivy-occur-mode-map (kbd "C-d") 'evil-scroll-down)

;;  (evil-define-key 'normal ivy-occur-mode-map (kbd "i") 'evil-insert)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (evil-define-key 'normal shell-mode-map (kbd "C-d") 'my/evil-scroll-down)
...
** Make C-u and C-u exit insert mode
#+BEGIN_SRC emacs-lisp
