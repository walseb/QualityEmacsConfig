...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/leader-map (kbd "g") 'my/vc-map)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/leader-map (kbd "C-m") 'my/music-map)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/leader-map (kbd "a") 'my/gnus-group-map)
  ...
  (define-key my/leader-map (kbd "a") 'my/gnus-summary-map)

  (evil-define-key 'normal gnus-group-mode-map (kbd (concat my/leader-map-key "a")) 'my/gnus-summary-map)

  (evil-define-key 'normal gnus-summary-mode-map (kbd "i") 'nil)

  ;; article mode
  (define-prefix-command 'my/gnus-article-map)
  (define-key my/leader-map (kbd "a") 'my/gnus-article-map)

  (evil-define-key 'normal gnus-group-mode-map (kbd (concat my/leader-map-key "a")) 'my/gnus-article-map)

  ;;  message
  (define-prefix-command 'my/gnus-message-map)
  (define-key my/leader-map (kbd "a") 'my/gnus-message-map)
