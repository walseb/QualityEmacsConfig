...
#+BEGIN_SRC emacs-lisp
  (my/evil-normal-define-key "g b" 'evil-downcase)
  (my/evil-normal-define-key "g B" 'evil-upcase)
#+END_SRC

*** Add perspective movement to g
#+BEGIN_SRC emacs-lisp
  (my/evil-normal-define-key "gw" 'evil-scroll-line-to-top)
  (my/evil-normal-define-key "ge" 'evil-scroll-line-to-center)
  (my/evil-normal-define-key "gu" 'evil-scroll-line-to-bottom)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Force autocomplete
  (my/evil-normal-define-key "C-." 'company-complete)
#+END_SRC
...
(my/evil-normal-define-key "C-w" 'evil-scroll-down)

(my/evil-normal-define-key "C-u" 'evil-scroll-up)
...
(my/evil-normal-define-key "gf" 'evil-close-fold)
(my/evil-normal-define-key "gF" '(lambda () (interactive) (hide-sublevels 1)))

(my/evil-normal-define-key "gh" 'outline-previous-heading)
#+END_SRC
