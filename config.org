...
#+BEGIN_SRC emacs-lisp
  ...
  ;; IRCC 100mb max garbage
  ;;(setq gc-cons-threshold 100000000)


  ;; never collect.
  (setq gc-cons-threshold 2500000000)

  (defun garbage-collect (&rest args) 
    (message "Emacs is trying to garbage collect, it's time to abandon ship"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/software-install-map (kbd "j") 'my/install-eclipse-java-lnguage-server)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/dired-mode-map (kbd "e") 'dired-toggle-read-only)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq lsp-java--workspace-folders (list "~/eclipse-workspace/"
                                          ""))
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/java-mode-map (kbd "c") 'lsp-java-extract-to-constant)
  (define-key my/java-mode-map (kbd "u") 'lsp-java-add-unimplemented-methods)
  (define-key my/java-mode-map (kbd "p") 'lsp-java-create-parameter)
  (define-key my/java-mode-map (kbd "f") 'lsp-java-create-field)
  (define-key my/java-mode-map (kbd "l") 'lsp-java-create-local)
  (define-key my/java-mode-map (kbd "m") 'lsp-java-extract-method)
  (define-key my/java-mode-map (kbd "i") 'lsp-java-add-import)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal pdf-view-mode-map (kbd "C-s") 'isearch-forward)
  (evil-define-key 'normal pdf-view-mode-map (kbd "M-s") 'isearch-backward)
  ...
  (evil-define-key 'normal pdf-view-mode-map (kbd "n") '(lambda () (interactive) (image-next-line 8)))
  (evil-define-key 'normal pdf-view-mode-map (kbd "p") '(lambda () (interactive) (image-previous-line 8)))
  (evil-define-key 'normal pdf-view-mode-map (kbd "h") '(lambda () (interactive) (image-backward-hscroll 8)))
  (evil-define-key 'normal pdf-view-mode-map (kbd "l") '(lambda () (interactive) (image-forward-hscroll 8)))

  (evil-define-key 'normal pdf-view-mode-map (kbd "i") 'nil)
  (evil-define-key 'normal pdf-view-mode-map (kbd "v") 'nil)

  ;;(evil-define-key 'normal pdf-view-mode-map (kbd my/leader-map-key) 'my/leader-map)
...
**** Fonts
#+BEGIN_SRC emacs-lisp
  ;; This is really only useful if doing a split mode line, disable this for now
  (setq my/are-fonts-mono t)
