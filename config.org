...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-define-key-in-mode ivy-minibuffer-map  "<escape>" 'ivy-call)
  ...
  ;;(my/evil-normal-define-key-in-mode ivy-minibuffer-map  "C-y" 'ivy-dispatching-done)
  ;;(my/evil-insert-define-key-in-mode ivy-minibuffer-map  "C-y" 'ivy-dispatching-done)
  ...
  (my/evil-normal-define-key-in-mode ivy-minibuffer-map  "C-f" 'ivy-backward-delete-char)
  (my/evil-insert-define-key-in-mode ivy-minibuffer-map  "C-f" 'ivy-backward-delete-char)
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal ivy-occur-mode-map (kbd "C-y") 'ivy-occur-read-action)
  ...
  (evil-define-key 'visual ivy-occur-mode-map (kbd "C-y") 'ivy-occur-read-action)
  ...
  (evil-define-key 'normal ivy-occur-grep-mode-map (kbd "C-y") 'ivy-occur-read-action)
  ...
  (evil-define-key 'visual ivy-occur-grep-mode-map (kbd "C-y") 'ivy-occur-read-action)
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal dired-mode-map (kbd "k") 'dired-single-up-directory)
  (evil-define-key 'insert dired-mode-map (kbd "k") 'dired-single-up-directory)
...
#+BEGIN_SRC emacs-lisp
  (eval-after-load 'exwm
    (progn
      ...
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-f" 'exwm-firefox-core-left)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "p" 'exwm-firefox-core-up)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "n" 'exwm-firefox-core-down)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-p" 'exwm-firefox-core-up)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-n" 'exwm-firefox-core-down)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;  `(,((my/repeat-char (string-trim comment-start) "" 2) . ,my/pretty-comment-symbol)))
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (defun my/set-face-to-default (face-name)
  ...
  (defun my/theme ()
    ...
    (set-face-attribute 'font-lock-string-face nil :foreground my/foreground-color :background my/background-color)
    ...
    ;;(my/set-face-to-default 'outline-4)
    (set-face-attribute 'outline-4 nil :foreground 'unspecified :foreground 'background :inherit 'default)
