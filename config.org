  ...
  (defun my/dired-sort-menu ()
    ...
    (dired-sort-other
     (pcase (completing-read "Sort by: " '( "date" "size" "name" "dir" "du" "~compatibility"))
       ("name" (progn (my/disable-dired-du-quietly) (concat my/dired-base-ls-command "")))
       ("date" (progn (my/disable-dired-du-quietly) (concat my/dired-base-ls-command "-t")))
       ("size" (progn (my/disable-dired-du-quietly) (concat my/dired-base-ls-command "--sort=size")))
       ("dir" (progn (my/disable-dired-du-quietly) (concat my/dired-base-ls-command "--group-directories-first")))
       ("~compatibility" (progn (my/disable-dired-du-quietly) "-al"))
       ("du" (progn (dired-sort-other "-al") (dired-du-mode 1) "-al")))))

  (defun my/disable-dired-du-quietly ()
    (if dired-du-mode
        (dired-du-mode -1)))

  (add-hook 'dired-mode-hook '(lambda () (progn (my/disable-dired-du-quietly) (concat my/dired-base-ls-command ""))))
