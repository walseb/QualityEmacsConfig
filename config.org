...
*** Create cursors in visual selection
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (my/evil-universal-define-key "C-g" 'my/evil-mc-keyboard-quit)

  (defun my/evil-mc-keyboard-quit ()
    (interactive)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;
  ;;   ("f" (call-interactively #'lispy-flow nil))
  ;;   ("b" (call-interactively #'lispy-back nil))
  ;;
