...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key evil-motion-state-map (kbd "g TAB") 'origami-close-node)

  (define-key evil-motion-state-map (kbd "g M-o") 'origami-open-all-nodes)
  (define-key evil-motion-state-map (kbd "g M-t") 'origami-close-all-nodes)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-define-key "gt" 'evil-close-fold)
  (my/evil-normal-define-key "gT" '(lambda () (interactive) (hide-sublevels 1)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/find-map (kbd "e") 'counsel-locate)

  (define-key my/find-map (kbd "s") 'counsel-ag)
#+END_SRC

** Custom locate
Locate only under current dir
#+BEGIN_SRC emacs-lisp
  (setq-default counsel-locate-cmd 'my/counsel-locate-cmd-default)

  (defun my/counsel-locate-cmd-default (input)
    "Return a shell command based on INPUT."
    (counsel-require-program "locate")
    (format "locate -i %s | grep -i %s"
            default-directory
