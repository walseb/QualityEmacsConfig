...
#+BEGIN_SRC emacs-lisp
  ...
  ;;                             (let ((enable 1))
  ;;                               (pcase major-mode
  ;;                                 ('emacs-lisp-mode (setq enable -1))
  ;;                                 ('clojure-mode (setq enable -1))
  ;;                                 ('scheme-mode (setq enable -1))
  ;;                                 ('common-lisp-mode (setq enable -1)))
  ;;                               (highlight-indent-guides-mode enable))))
...
#+BEGIN_SRC emacs-lisp
  (defhydra my/lispy-hydra (:hint nil
    ...
    ("i" (call-interactively #'lispy-tab nil))

    ("u" (call-interactively #'lispy-flow nil))
    ("d" (call-interactively #'lispy-different nil))
    ("o" (call-interactively #'lispy-other-mode nil))
    ("k" (call-interactively #'lispy-eval-other-window nil))
    ("K" (call-interactively #'lispy-paste nil))
    ("y" (call-interactively #'lispy-occur nil))
    ("z" (call-interactively #'lh-knight/body nil))
    ("<escape>" nil nil))
