...
#+BEGIN_SRC emacs-lisp
  ...
  (if (not fully-compatible-system)
      (progn
        (setq backup-directory-alist `((".*" . ,temporary-file-directory)))
        (setq auto-save-file-name-transforms `((".*" ,temporary-file-directory t))))
    (progn
      (setq backup-directory-alist '(("." . "~/.emacs.d/saves/")))
      (setq auto-save-file-name-transforms `(("." ,"~/.emacs.d/auto-saves/")))))
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/keys-mode-map (kbd "M-t") 'my/window-hydra/body)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (exwm-input-set-key (kbd "M-t") 'my/window-hydra/body)
...
#+BEGIN_SRC emacs-lisp
  (defhydra my/window-hydra (:color red
    ...
    ;;  Switch workspace
    ;; Workspace 0
    ("A" (lambda () (interactive) (exwm-workspace-switch-create 0)))
    ("N" (lambda () (interactive) (exwm-workspace-switch-create 1)))
    ("E" (lambda () (interactive) (exwm-workspace-switch-create 2)))
    ("T" (lambda () (interactive) (exwm-workspace-switch-create 3)))
    ("O" (lambda () (interactive) (exwm-workspace-switch-create 4)))
    ("S" (lambda () (interactive) (exwm-workspace-switch-create 5)))
    ("H" (lambda () (interactive) (exwm-workspace-switch-create 6)))
    ("D" (lambda () (interactive) (exwm-workspace-switch-create 7)))
    ("I" (lambda () (interactive) (exwm-workspace-switch-create 8)))
    ("R" (lambda () (interactive) (exwm-workspace-switch-create 9)))
