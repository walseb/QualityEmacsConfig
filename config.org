...
** Eldoc doesn't resize
Checkout eldoc-echo-area-use-multiline-p
Might be a problem with the exwm minibuffer stuff
Resize-mini-windows?
...
*** Move by paragraph easier
#+BEGIN_SRC emacs-lisp
  (my/evil-normal-define-key "j" 'evil-forward-paragraph)
  (my/evil-visual-define-key "j" 'evil-forward-paragraph)

  (my/evil-normal-define-key "J" 'evil-backward-paragraph)
  (my/evil-visual-define-key "J" 'evil-backward-paragraph)
#+END_SRC
