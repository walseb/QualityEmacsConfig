...
** Change with-current-buffer to buffer-local-value
in section company-doc-buffer and more maybe
** Use lexical bindings in config
** Fix paren outside screen preview
Currently picks paren one left of cursor
