...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-define-key "g o" 'hs-show-block)
  (my/evil-normal-define-key "g O" 'hs-show-all)

  (my/evil-normal-define-key "g C-o" 'evil-open-fold)
  (my/evil-normal-define-key "g C-O" 'evil-open-fold-rec)

  ;; Show only nodes
  (my/evil-normal-define-key "g a" 'hs-hide-level)
  (my/evil-normal-define-key "g A" 'hs-show-all)

  (my/evil-normal-define-key "g RET" 'my/outline-hide-all-body)
  (my/evil-normal-define-key "g C-a" 'outline-show-all)

  (my/evil-normal-define-key "g h" 'hs-hide-block)
  (my/evil-normal-define-key "g H" 'hs-hide-all)

  (my/evil-normal-define-key "g C-h" 'evil-close-fold)
  (my/evil-normal-define-key "g C-H" '(lambda () (interactive) (hide-sublevels 1)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'eldoc-mode-hook '(lambda () (interactive)
