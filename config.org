...
#+BEGIN_SRC emacs-lisp
  (defvar locate-cache nil)

  (defun my/locate-update-cache ()
    (setq locate-cache (split-string
...
#+BEGIN_SRC emacs-lisp
  (define-key my/leader-map (kbd "c") 'my/comments-toggle)
  (defvar my/comment-hide nil)

  (defconst my/comment-default-face-foreground nil)
  (defconst my/comment-default-face-background nil)

  (defun my/comments-store-faces()
    (setq my/comment-default-face-foreground (face-attribute 'font-lock-comment-face :foreground))
    (setq my/comment-default-face-background (face-attribute 'font-lock-comment-face :background)))

  (defun my/comments-toggle ()
    (interactive)
    (unless my/comment-default-face-foreground
      (my/comments-store-faces))

    (setq my/comment-hide (not my/comment-hide))
    (if my/comment-hide
        (set-face-attribute 'font-lock-comment-face nil :foreground my/background-color :background my/background-color)
      (set-face-attribute 'font-lock-comment-face nil :foreground my/comment-default-face-foreground :background my/comment-default-face-background)))
#+END_SRC
