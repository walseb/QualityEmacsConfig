...
** Trim string
#+BEGIN_SRC emacs-lisp
  (defun my/trim-whitespace (string)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/evil-universal-define-key-in-mode (mode key command)
    ...
    (my/evil-universal-define-key-in-mode mode key command)
  ...
  (defun my/evil-normal-visual-define-key (key command)
    (interactive)
    (define-key evil-normal-state-map (kbd key) command)
    (define-key evil-motion-state-map (kbd key) command)
...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-visual-define-key "q" 'my/macro-record-toggle)
  (my/evil-normal-visual-define-key "Q" 'my/macro-run)
#+END_SRC
  ...
  (add-hook 'prog-mode-hook (lambda () (interactive) 
                              (setq-local prettify-symbols-alist
                                          (append
                                           ...
                                           `((,(my/trim-whitespace comment-start) . ?|)))))
            t)
