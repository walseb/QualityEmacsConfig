...
#+BEGIN_SRC emacs-lisp
  (define-key evil-normal-state-map (kbd "g b") 'evil-downcase)
  (define-key evil-normal-state-map (kbd "g B") 'evil-upcase)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key evil-normal-state-map (kbd "^") 'my/go-to-middle-of-line)
#+END_SRC
...
** Keys
#+BEGIN_SRC emacs-lisp
  (define-key evil-normal-state-map (kbd "M-f") 'avy-goto-char-in-line)
  (define-key my/leader-map (kbd "f") 'avy-goto-char-in-line)

  (define-key evil-normal-state-map (kbd "M-w") 'my/avy-goto-word-0-in-line)
  (define-key my/leader-map (kbd "w") 'my/avy-goto-word-0-in-line)

  (define-key evil-normal-state-map (kbd "M-g") 'avy-goto-char-2)
  (define-key my/leader-map (kbd "g") 'avy-goto-char-2)

  (define-key evil-normal-state-map (kbd "M-g") 'avy-goto-char-2)
  (define-key my/leader-map (kbd "g") 'avy-goto-char-2)

  (define-key evil-normal-state-map (kbd "M-n") 'avy-goto-word-0-below)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key evil-normal-state-map "P" 'delete-indentation)
  (define-key evil-motion-state-map "P" 'delete-indentation)
...
#+BEGIN_SRC emacs-lisp
  (if my/device/monitor-setup
      (progn
        ...
        (setq exwm-randr-workspace-output-plist my/device/monitor-setup)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun pretty-outlines--propertize-bullet (level bullet)
    ...
    (with-face bullet
               (pcase level
                 (0 '(:inherit outline-1 :underline nil :background nil :height 1.9))
                 (1 '(:inherit outline-2 :underline nil :background nil :height 1.6))
                 (2 '(:inherit outline-3 :underline nil :background nil :height 1.4))
                 (3 '(:inherit outline-4 :underline nil :background nil :height 1.3))
                 (4 '(:inherit outline-5 :underline nil :background nil :height 1.25))
                 (5 '(:inherit outline-6 :underline nil :background nil :height 1.2))
                 (6 '(:inherit outline-7 :underline nil :background nil :height 1.15))
                 (7 '(:inherit outline-8 :underline nil :background nil :height 1.10))
                 (_ nil))))
