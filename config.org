...
#+BEGIN_SRC emacs-lisp
  ...
  (setq aw-dispatch-alist
        '(
          ...
          ;; Switch buffer
          (?f aw-switch-buffer-other-window "Change buffer")
          ;; Switch buffer
          (?F ivy-switch-buffer)
          ...
          ;; Split horizontally
          (?p aw-split-window-horz "Split Horz Window")
          (?P my/split-and-follow-horozontally)
          ...
          ;; Focus
          (?w delete-other-windows "Focus on window")
