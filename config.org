...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'eww-mode-hook 'my/keys-mode-turn-off)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/mark-move (jump-distance)
    ...
    (my/reset-current-marks-if-mark-ring-change)
    (or mark-ring
        (error "No mark set"))
  ...
  (define-key evil-normal-state-map (kbd "H") '(lambda () (interactive) (my/mark-move 1)))
  (define-key evil-normal-state-map (kbd "L") '(lambda () (interactive) (my/mark-move -1)))

  (evil-define-key 'normal my/keys-mode-map (kbd "M-h") 'previous-buffer)
  (evil-define-key 'normal my/keys-mode-map (kbd "M-l") 'next-buffer)
#+END_SRC
