...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'insert dired-mode-map (kbd "k") 'dired-up-directory)

  (evil-define-key 'normal dired-mode-map (kbd "K") 'my/dired-kill-and-go-down)
  (evil-define-key 'insert dired-mode-map (kbd "K") 'my/dired-kill-and-go-down)
