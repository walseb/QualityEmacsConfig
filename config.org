...
#+BEGIN_SRC emacs-lisp
  (defun my/paper-mode()
    ...
    (set-face-attribute  'font-lock-comment-face nil :foreground "dark green" :background my/background-color :underline t)
    (set-face-attribute 'outline-4 nil :foreground my/foreground-color :background my/background-color)

    (set-face-attribute 'font-lock-string-face nil :foreground my/foreground-color :background (color-lighten-name my/background-color 5))
    ...
    (set-face-attribute 'ivy-minibuffer-match-face-2 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 10))
    (set-face-attribute 'ivy-minibuffer-match-face-3 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 20))
    (set-face-attribute 'ivy-minibuffer-match-face-4 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 30))

    ;;; Swiper
    (set-face-attribute 'swiper-match-face-1 nil :foreground my/background-color :background my/foreground-color)
    (set-face-attribute 'swiper-match-face-2 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 10))
    (set-face-attribute 'swiper-match-face-3 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 20))
    (set-face-attribute 'swiper-match-face-4 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 30))

    ;;; Avy
    (set-face-attribute 'avy-lead-face nil :foreground my/background-color :background my/foreground-color)
    (set-face-attribute 'avy-lead-face-0 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 10))
    (set-face-attribute 'avy-lead-face-1 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 20))
    (set-face-attribute 'avy-lead-face-2 nil :foreground my/background-color :background (color-lighten-name my/foreground-color 30))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/launch-firefox ()
    ...
    (let* (
      ...
      (start-process (concat "firefox" my/temp-firefox-title-name) nil "firefox" "--new-window" adress)
