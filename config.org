...
#+BEGIN_SRC emacs-lisp
  ...
  ;; (evil-define-key 'normal undo-tree-visualizer-mode-map (kbd "p") 'evil-previous-line)
  ;; (evil-define-key 'normal undo-tree-visualizer-mode-map (kbd "n") 'evil-next-line)
