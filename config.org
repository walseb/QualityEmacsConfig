...
#+BEGIN_SRC emacs-lisp
  ...
  (if (my/should-backup-buffer)
      (save-restriction (widen) (write-region (point-min) (point-max) (concat backup-path (number-to-string (floor (float-time))) (my/backup-format-file-path (buffer-file-name))) nil nil nil t))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-define-key "g o" 'origami-open-node)
  (my/evil-normal-define-key "g O" 'origami-open-node-recursively)

  (my/evil-normal-define-key "g C-o" 'evil-open-fold)
  (my/evil-normal-define-key "g C-O" 'evil-open-fold-rec)

  (my/evil-normal-define-key "g a" 'origami-show-only-node)
  (my/evil-normal-define-key "g A" 'origami-open-all-nodes)

  (my/evil-normal-define-key "g RET" 'my/outline-hide-all-body)
  (my/evil-normal-define-key "g C-a" 'outline-show-all)

  (my/evil-normal-define-key "g k" 'origami-close-node)
  (my/evil-normal-define-key "g K" 'origami-close-node-recursively)

  (my/evil-normal-define-key "g C-k" 'evil-close-fold)
  (my/evil-normal-define-key "g C-K" '(lambda () (interactive) (hide-sublevels 1)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal ivy-occur-mode-map (kbd "D") 'ivy-occur-delete-candidate)
  ...
  (evil-define-key 'visual ivy-occur-mode-map (kbd "D") 'ivy-occur-delete-candidate)
  ...
  (evil-define-key 'normal ivy-occur-grep-mode-map (kbd "D") 'ivy-occur-delete-candidate)
  ...
  (evil-define-key 'visual ivy-occur-grep-mode-map (kbd "D") 'ivy-occur-delete-candidate)
...
*** Keys
#+BEGIN_SRC emacs-lisp
  (my/evil-normal-define-key "g n" 'indentation-forward-to-next-sibling)
  (my/evil-visual-define-key "g n" 'indentation-forward-to-next-sibling)

  (my/evil-normal-define-key "g p" 'indentation-backward-to-previous-sibling)
  (my/evil-visual-define-key "g p" 'indentation-backward-to-previous-sibling)

  (my/evil-normal-define-key "g h" 'indentation-up-to-parent)
  (my/evil-visual-define-key "g h" 'indentation-up-to-parent)

  (my/evil-normal-define-key "g l" 'indentation-down-to-child)
  (my/evil-visual-define-key "g l" 'indentation-down-to-child)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/macro-prompt ()
    ;; Ivy doesn't sort, so use it
    (ivy-read "Macros: "  (my/macro-get-names)))
  ...
  (defun my/macro-run-prompt (count)
    (interactive "P")
    (my/macro-run (my/macro-prompt) count)
  ...
  (defun my/macro-modify ()
    (interactive)
    (let* ((macro-name (my/macro-prompt))
...
#+BEGIN_SRC emacs-lisp
  ...
  (my/evil-normal-define-key "s" 'avy-goto-subword-0)
  (my/evil-normal-define-key "S" 'avy-goto-subword-1)

  (my/evil-visual-define-key "s" 'avy-goto-subword-0)
  (my/evil-visual-define-key "S" 'avy-goto-subword-1)
