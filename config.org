...
#+BEGIN_SRC emacs-lisp
  ...
  name \"pulse audio\"
    ...
    (my/create-file-if-not-exist (concat my/mpd-directory "playlists")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/monitor-home-setup ()
    (interactive)
    (shell-command "xrandr --output DP-1 --mode 2560x1440 --rate 60 --left-of DVI-I-1 --output DVI-D-1 --mode 1280x800 --left-of DP-1 --output DVI-I-1 --mode 1280x800"))
  (define-key my/system-monitor-map (kbd "s") 'my/monitor-home-setup)
#+END_SRC
