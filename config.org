...
#+BEGIN_SRC emacs-lisp
  (when (version<= "26.0.50" emacs-version )
    ...
    (add-hook 'org-mode-hook (lambda ()(interactive) (setq display-line-numbers-type 'visual)))
                     ...
                     (
                      ...
                      (:eval (if my/work-timer-last-add-to-total-time
                               ...
                               (if my/work-timer-blink
                                 ...
                                 ;; (set-face-attribute 'mode-line nil :background my/background-color )
