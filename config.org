...
#+BEGIN_SRC emacs-lisp
  ;; (straight-use-package '(mu4e :type git :host github :repo "djcb/mu"
                               ;; :files ("mu4e/mu4e-view.el")))
  ;; (straight-use-package '(mu :type git :host github :repo "djcb/mu"
                             ;; :files((:exclude"mu4e/*"))))
  ;; (setq mu4e-mu-binary
        ...
        ;; (expand-file-name
         ;; (concat
          ...
          ;; "straight/build/mu4e")))
;; 
  ;; (defun my/install-mu4e ()
  ;; (interactive)
  ;; (shell-command (concat "cd " user-emacs-directory "straight/repos/mu4e; ./autogen.sh; make")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'exwm-init-hook '(lambda () (interactive) (run-with-timer 0.2 nil '(lambda () (interactive) (my/frame-width-update) (my/lv-line--update)))) t)
