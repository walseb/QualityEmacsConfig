...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal ivy-minibuffer-map (kbd "RET") 'ivy-done)
#+END_SRC
...
*** Rebind search key 
#+BEGIN_SRC emacs-lisp
  ;; (my/evil-normal-define-key "s" 'evil-search-forward)
  ;; (my/evil-normal-define-key "S" 'evil-search-backward)
  ;; (define-key evil-visual-state-map "s" 'evil-search-forward)
  ;; (define-key evil-visual-state-map "S" 'evil-search-backward)

  (my/evil-normal-define-key "s" 'isearch-forward)
  (my/evil-normal-define-key "S" 'isearch-backward)

  (define-key evil-visual-state-map "s" 'isearch-forward)
  (define-key evil-visual-state-map "S" 'isearch-backward)
...
#+BEGIN_SRC emacs-lisp
  (eval-after-load 'exwm
   ...
   ;;; Normal
      ...
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-l" '(lambda () (interactive) (exwm-input--fake-key 'delete)))
      (my/evil-normal-define-key-in-mode  exwm-firefox-evil-mode-map "C-h" '(lambda () (interactive) (exwm-input--fake-key 'backspace)))
   ...
   ;;; Visual
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "p" 'exwm-firefox-core-up-select)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "n" 'exwm-firefox-core-down-select)

      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-w" 'exwm-firefox-core-half-page-down-select)
   ...
   ;;; Insert
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-p" 'exwm-firefox-core-up-select)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-n" 'exwm-firefox-core-down-select)

      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-u" 'exwm-firefox-core-half-page-up)
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "C-w" 'exwm-firefox-core-half-page-down)

      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "M-w" '(lambda () (interactive) (exwm-input--fake-key ?\å)))
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "M-r" '(lambda () (interactive) (exwm-input--fake-key ?\ä)))
      (my/evil-normal-define-key-in-mode exwm-firefox-evil-mode-map "M-j" '(lambda () (interactive) (exwm-input--fake-key ?\ö)))
...
#+BEGIN_SRC emacs-lisp
  (defun my/paper-mode()
    ...
    (set-face-attribute 'diff-refine-added nil  :background my/diff-added-color)
    (set-face-attribute 'diff-refine-changed nil :background my/diff-changed-color)
    (set-face-attribute 'diff-refine-removed nil :background my/diff-removed-color)
    ...
    ;;; Eldoc inline
    ;; If eldoc overlay is in use
    (if (require 'eldoc-overlay nil 'noerror)
        (set-face-attribute 'quick-peek-background-face nil :foreground my/foreground-color-6 :background my/background-color))
