  ...
  (defun my/create-file-with-content-if-not-exist (file content)
    (if (not (file-exists-p file))
        (progn
          ...
          (message (concat "file: " file " created with content: " content)))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key evil-normal-state-map  (kbd "C-,") 'company-show-doc-buffer)
  (define-key evil-insert-state-map  (kbd "C-,") 'company-show-doc-buffer)
...
**** Auto-run mpd if installed
#+BEGIN_SRC emacs-lisp
  (if (my/run-and-is-external-package-installed "mpd -h")
      (progn
        (my/setup-mpd)
        (my/start-mpd)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/monitor-home-setup ()
    (interactive)
    (shell-command "xrandr --output DP-1 --mode 2560x1440 --left-of DVI-I-1 --output DVI-D-1 --mode 1280x800 --rate 59.81 --left-of DP-1 --output DVI-I-1 --mode 1280x800 --rate 59.81"))
...
#+BEGIN_SRC emacs-lisp
  (defvar my/switch-buffer-hook nil
    "Hook called after use has changed buffer")
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/linux-update-network-rx-delta ()
    (interactive)
      ...
      (setq my/rx-delta-formatted (file-size-human-readable (- my/rx-new my/rx)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/linux-update-network-tx-delta ()
    (interactive)
     ...
     (setq my/tx-delta-formatted (file-size-human-readable (- my/tx-new my/tx)))
