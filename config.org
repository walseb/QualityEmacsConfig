...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/force-backup-of-buffer ()
    ...
    (if (and my/create-per-session-backups (< (point-max) my/per-session-backup-limit) (buffer-modified-p))
        (save-restriction (widen) (write-region (point-min) (point-max) (concat my/backup-per-session-directory (buffer-name) (number-to-string (time-to-seconds))) nil nil nil))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal my/org-mode-map (kbd "C-e") 'my/org-export-map)

  (define-key my/org-export-map (kbd "C-e") 'org-twbs-export-to-html)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal evil-normal-state-map (kbd "C-.") 'company-complete)
  (evil-define-key 'insert evil-insert-state-map (kbd "C-.") 'company-complete)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (evil-define-key 'normal my/keys-mode-map (kbd (concat "C-" my/window-leader-key)) 'my/window-hydra/body)
  (evil-define-key 'insert my/keys-mode-map (kbd (concat "C-" my/window-leader-key)) 'my/window-hydra/body)
...
#+BEGIN_SRC emacs-lisp
  ...
  (exwm-input-set-key (kbd (concat "C-" my/window-leader-key)) 'my/window-hydra/body)
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key my/vc-map (kbd "g") 'git-gutter)
