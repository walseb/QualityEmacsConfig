...
** Example
(define-key my/leader-map (kbd "key") 'function)
* Minor
** Startup
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Disable hints
  (setq switch-window-shortcut-appearance nil)
...
** Binds
#+BEGIN_SRC emacs-lisp
  (define-key my/help-menu-map (kbd "C-m") 'manage-minor-mode)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Webjump
  (define-key my/leader-map (kbd "b") 'webjump)
  (define-key my/leader-map (kbd "C-b") (lambda () (interactive) (my/webjump-use-browser "firefox")))
#+END_SRC
